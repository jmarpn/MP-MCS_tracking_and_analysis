...
%%%% save these for some other violin plots (a reviewer suggestion)
MP_vorticity_MCSI_4violins       =  MPVORTatMCSI_ALLYRS;
MP_area_MCSI_4violins            =  MPAREAatMCSI_ALLYRS;
...
MP_meanMUCIN          =  MPmeanMUCINfullmcs_ALLYRS;
...
%%%% save these for some other violin plots (a reviewer suggestion)
MP_vorticity_fullmcs_4violins       =  MPVORTfullmcs_ALLYRS(:) ;
MP_area_fullmcs_4violins            =  MPAREAfullmcs_ALLYRS(:) ;

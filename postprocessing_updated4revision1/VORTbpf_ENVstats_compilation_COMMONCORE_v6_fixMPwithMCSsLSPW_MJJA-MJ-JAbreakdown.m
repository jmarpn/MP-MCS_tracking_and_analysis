...
title([' mean wind dir in MP object',keptmonslab],'FontSize',15)
ax = gca;
ax.FontSize = 15
xticks( [0:15:360])
...
%saveas(ff,horzcat(imout,'/MCSIhist_totrain.png'));
outlab = horzcat(imout,'/MPhist_meanWNDDIR600_MPwithwithoutMCSsMCSI',keptmonslab,'.eps')
EPSprint = horzcat('print -painters -depsc ',outlab);
eval([EPSprint]);

...
dir_demo='<YOUR DIRECTORY HERE>'

# Example config file name
config_demo='config_era5_vor_bp_2004_morevars_synoptic.yml'
...
conda activate /global/u2/j/jmarquis/PyFLEXTRKR/flextrkr
...
python ../Analysis/plot_subset_psi_tracks_demo.py -s '2004-05-01T00' -e '2004-05-04T00' \

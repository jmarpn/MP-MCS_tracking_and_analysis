...
config_demo='config_era5_vor_bp_2006_morevars.yml'
...
python ../Analysis/plot_subset_psi_tracks_demo.py -s '2004-05-01T00' -e '2004-05-02T00' \
...
ffmpeg -framerate 8 -pattern_type glob -i ${quicklook_dir}'*.png' -c:v libx264 -r 10 -crf 20 -pix_fmt yuv420p \
    -y ${quicklook_dir}quicklook_2000vor_animation.mp4

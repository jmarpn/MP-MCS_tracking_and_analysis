...
% primary data directory with subdirectories of your input data:
rootdir = '     ';
...
MCSstatfile = 'mcs_tracks_final_20040101.0000_20050101.0000.nc' ;
% ncdisp(MCSstatfile)
...
for yr = 1 : ay
    ...
    %matout =  strcat(rootdir,YEARS(yr,:),'_vorstats_masks_zone_v5.mat')   ;
...
outlab = horzcat(imout,'/MCSIorigins_allevents_filtLS',num2str(filteroutLS),'.eps');
EPSprint = horzcat('print -painters -depsc ',outlab);
eval([EPSprint]);
...
if(  filteroutLS ==  1)
    ...
    outlab = horzcat(imout,'/MCSIorigins_allevents_WITHLS_filtLS',num2str(filteroutLS),'.eps');
    EPSprint = horzcat('print -painters -depsc ',outlab);
    eval([EPSprint]);
...
outlab = horzcat(imout,'/MParea_atMCSI_andfull',num2str(filteroutLS),'.eps');
EPSprint = horzcat('print -painters -depsc ',outlab);
eval([EPSprint]);
...
outlab = horzcat(imout,'/MPvort_atMCSI',num2str(filteroutLS),'.eps');
EPSprint = horzcat('print -painters -depsc ',outlab);
eval([EPSprint]);
...
%saveas(ff,horzcat(imout,'/MCSIhist_totrain.png'));
outlab = horzcat(imout,'/MCSIhist_convarea_filtLS',num2str(filteroutLS),'.eps')
EPSprint = horzcat('print -painters -depsc ',outlab);
%eval([EPSprint]);
...
%saveas(ff,horzcat(imout,'/MPorigin_largetotprecipMCS.png'));
outlab = horzcat(imout,'/MPorigin_largeconvarea_filtLS',num2str(filteroutLS),'.eps')
EPSprint = horzcat('print -painters -depsc ',outlab);
%eval([EPSprint]);
...
%saveas(ff,horzcat(imout,'/MPorigin_medtotprecipMCS.png'));
outlab = horzcat(imout,'/MPorigin_medconvarea_filtLS',num2str(filteroutLS),'.eps')
EPSprint = horzcat('print -painters -depsc ',outlab);
%eval([EPSprint]);
...
%saveas(ff,horzcat(imout,'/MPorigin_smalltotprecipMCS.png'));
outlab = horzcat(imout,'/MPorigin_smallconvarea_filtLS',num2str(filteroutLS),'.eps')
EPSprint = horzcat('print -painters -depsc ',outlab);
%eval([EPSprint]);
...
if(filteroutLS==1)
    ...
    outlab = horzcat(imout,'/MCSIhist_LSMPMCS_convarea_filtLS',num2str(filteroutLS),'.eps')
    EPSprint = horzcat('print -painters -depsc ',outlab);
    %eval([EPSprint]);
...
%saveas(ff,horzcat(imout,'/MCSIhist_totrain.png'));
outlab = horzcat(imout,'/MCSIhist_stratarea_filtLS',num2str(filteroutLS),'.eps')
EPSprint = horzcat('print -painters -depsc ',outlab);
%eval([EPSprint]);
...
%saveas(ff,horzcat(imout,'/MPorigin_largetotprecipMCS.png'));
outlab = horzcat(imout,'/MPorigin_largestratarea_filtLS',num2str(filteroutLS),'.eps')
EPSprint = horzcat('print -painters -depsc ',outlab);
%eval([EPSprint]);
...
%saveas(ff,horzcat(imout,'/MPorigin_medtotprecipMCS.png'));
outlab = horzcat(imout,'/MPorigin_medstratarea_filtLS',num2str(filteroutLS),'.eps')
EPSprint = horzcat('print -painters -depsc ',outlab);
%eval([EPSprint]);
...
%saveas(ff,horzcat(imout,'/MPorigin_smalltotprecipMCS.png'));
outlab = horzcat(imout,'/MPorigin_smallstratarea_filtLS',num2str(filteroutLS),'.eps')
EPSprint = horzcat('print -painters -depsc ',outlab);
%eval([EPSprint]);
...
if(filteroutLS==1)
    ...
    outlab = horzcat(imout,'/MCSIhist_LSMPMCS_stratarea_filtLS',num2str(filteroutLS),'.eps')
    EPSprint = horzcat('print -painters -depsc ',outlab);
    %eval([EPSprint]);
...
%saveas(ff,horzcat(imout,'/MPorigin_largeareaMCS.png'));
outlab = horzcat(imout,'/MPorigin_NW_filtLS',num2str(filteroutLS),'.eps')
EPSprint = horzcat('print -painters -depsc ',outlab);
eval([EPSprint]);

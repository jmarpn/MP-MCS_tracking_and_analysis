...
primary directory continaing input directories with data:
rootdir = '';
...
% MP_with_MCSs_ALLYRS      =  MP_with_MCSs_ALLYRS    .*  mask_killPWbelow24mm;
% MP_without_MCSs_ALLYRS   =  MP_without_MCSs_ALLYRS .*  mask_killPWbelow24mm;
for y = 1:MP_years
    for n = 1:MP_tracks
...
outlab = horzcat('MPwinddir_bymonth.eps')
EPSprint = horzcat('print -painters -depsc ',outlab);
eval([EPSprint]);

...
%primary root dir from which your input are located:
rootdir = '   ';

mkdir(   strcat(rootdir,'/images')  )
imout = strcat(rootdir,'/images');

%just grab a random MCS stats file for referencing array sizes for future use
MCSstatfile = '/mcs_tracks_final_20040101.0000_20050101.0000.nc' ;


%ocation of ERA5 environment files within MP objects (e.g., AFWA CAPE, CIN, shear, etc.)
mpenvdir = '    ';
...
%%%%%  apply these LS filters here before all else?
if(filteroutLS == 1)
